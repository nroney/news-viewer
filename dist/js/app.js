...
window.app = {
	...
	isAdmin: true,
	apiUrl: 'http://nroney.com/mm/phonegap/',
...
AddView = Backbone.View.extend({
	...
	events:
	{
		'click .btn-submit-app': 'addApp'
	},

	initialize: function () {
		var _this = this;

		GlobalModel('getUsers.php', function (model) {
		 	_this.render(model);
			app.afterRender();
		 });
	...
	addApp: function(){
		...
		$.post(app.apiUrl + 'addApp.php', {
			appIdentifier: $form.find('input[name="project-name"]').val(),
...
LoginView = Backbone.View.extend({
	...
	login: function(e){
		var username = $('#loginUsername').val(),
			...
			$.post(app.apiUrl+'login.php', { email: username, password: password}, function( data ) {
				console.log(data);
...
MainView = Backbone.View.extend({
	...
	events: {
		...
		'click .app-list-item a': 'setSelectedApp'
	},
	...
	setSelectedApp: function(e){
		localStorage.setItem('selectedAppId', $(e.currentTarget).attr('data-appId'));
	...
	render: function () {
		var _this = this;
		$.post( "https://build.phonegap.com/authorize?client_id=891175fbcdef6ced284b&client_secret=0d58375cded327848267389354ba179b5bd285b8&auth_token=3CLrukS_ACNN3Xo-Cs9h", function( data ) {
